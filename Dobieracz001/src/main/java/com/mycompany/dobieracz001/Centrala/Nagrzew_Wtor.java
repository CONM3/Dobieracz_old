...
// * 
// *
// * @since 2017-09-12, 23:45:05
// * @author Grzegorz Brodowski
// */
//public class Nagrzew_Wtor {
//
//}
//
//using System;
...
//{
//    public partial class Nagrzewnica_wtorna : Form
//    {
//        public Nagrzewnica_wtorna()
//        {
//            InitializeComponent();
//        }
//
...
//        }
//
//        private void elektryczna_radioButton_CheckedChanged(object sender, EventArgs e)
//        {
//            typ_panel.Enabled = false;
//            budowa_panel.Enabled = false;
//            wodna_panel.Visible = false;
//            elektryczna_panel.Visible = true;
//            elektryczna_panel.Enabled = true;
//            label1.Enabled = false;
//            label3.Enabled = false;
//            ClearAll();
//            tablica_urzadzen.DodajNowe("temp_nagrzewnica_wtorna", "brak", "0", 0,0,0,0);
//        }
//
...
//            try
//            {
//                double spr = Convert.ToDouble(moc_textBox.Text);
//                zawor_pradowy();
//                zawor_label.Text = "";
//                //silownik_label.Text = "";
//            }
...
//        {
//            if (wodna_radioButton.Checked)
//                tablica_urzadzen.DodajNowe("temp_nagrzewnica_wtorna", "TT-551-B", "1", 1, 0, 0, 0);
//
//            if (zawor_label.Text == "" && zawor_pradowy_label.Text == "")
//                MessageBox.Show("Nie wybrano zaworu");
//
//            if (zawor_label.Text != "" && zawor_label.Text != "brak")
//            {
//                tablica_urzadzen.DodajNowe("zawor_nagrzewnica_wtorna", zawor_label.Text, "1", 0, 0, 0, 0);
//                tablica_urzadzen.DodajNowe("silownik_nagrzewnica_wtorna", silownik_label.Text, "1", 0, 0, 1, 0);
//                tablica_urzadzen.DodajNowe("syg_pompa_wtorna", "TAK", "1", 0, 1, 0, 1);
//                Close();
//            }
//            if (zawor_pradowy_label.Text != "")
//            {
//                tablica_urzadzen.DodajNowe("silownik_nagrzewnica_wtorna", "brak", "0", 0, 0, 0, 0);
//                tablica_urzadzen.DodajNowe("zawor_nagrzewnica_wtorna", zawor_pradowy_label.Text, "1", 0, 0, 1, 0);
//                tablica_urzadzen.DodajNowe("temp_nagrzewnica_wtorna", "brak", "0", 0, 0, 0, 0);
//                tablica_urzadzen.DodajNowe("syg_pompa_wtorna", "NIE", "0", 0, 0, 0, 0);
//                Close();
//            }
//
//            if (brak_radioButton.Checked)
//            {
//                tablica_urzadzen.DodajNowe("zawor_nagrzewnica_wtorna", "brak", "0", 0, 0, 0, 0);
//                tablica_urzadzen.DodajNowe("silownik_nagrzewnica_wtorna", "brak", "0", 0, 0, 0, 0);
//                tablica_urzadzen.DodajNowe("syg_pompa_wtorna", "NIE", "0", 0, 0, 0, 0);
//                Close();
//            }
