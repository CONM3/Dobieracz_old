...
// * 
// *
// * @since 2017-09-12, 23:46:09
// * @author Grzegorz Brodowski
// */
//public class PrzepustnicaNawiew {
//
//}
//using System;
...
//{
//    public partial class PrzepustnicaNawiew : Form
//    {
...
//        }
//
//        public void AddDataToTable(string urzadzenie, string ilosc, DataTable myTable)
//        {
//            DataRow row;
//
//            row = myTable.NewRow();
...
//        {
//            DataTable Urzadzenia_Ilosci = new DataTable();
//
//            DataColumn myDataColumn;
//
//            myDataColumn = new DataColumn();
//            myDataColumn.DataType = Type.GetType("System.String");
//            myDataColumn.ColumnName = "Urządzenie";
//            Urzadzenia_Ilosci.Columns.Add(myDataColumn);
//
//            myDataColumn = new DataColumn();
//            myDataColumn.DataType = Type.GetType("System.String");
//            myDataColumn.ColumnName = "Ilość";
//            Urzadzenia_Ilosci.Columns.Add(myDataColumn);
//
//            //myDataColumn = new DataColumn();
//            //myDataColumn.DataType = Type.GetType("System.String");
...
//        {
//            //StreamWriter test = new StreamWriter("D:\\Dobór central\\TestFile.txt");
//            //DataTable Zestawienie;
//            wpisTab(silownik, IloscSilownikow_numericUpDown.Value);
//            Spr_akcesoria();
//            sprWeWy();
//            tablica_urzadzen.DodajNowe("silownik_przepustnicy_nawiew", SilownikNawiew_Tab[0, 0], SilownikNawiew_Tab[0, 1], AI, DI, AO, DO);
//            tablica_urzadzen.DodajNowe("silownik_przepustnicy_nawiew_akc", SilownikNawiew_Tab[1, 0], SilownikNawiew_Tab[1, 1], AI_akc, DI_akc, AO_akc, DO_akc);
...
//            
//
//            //test.WriteLine(SilownikNawiew_Tab[0, 0]);
//            //test.WriteLine(SilownikNawiew_Tab[0, 1]);
//            //Zestawienie = CreateDataTable();
//            //AddDataToTable(SilownikNawiew_Tab[0, 0], SilownikNawiew_Tab[0, 1], Zestawienie);
//            //dataGridView1.DataSource = (Zestawienie).DefaultView;
//            ///test.Close();
//            
//
//        }
